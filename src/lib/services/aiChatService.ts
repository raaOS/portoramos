                ...
                try {
                    ...
                    if (groqRes.ok) {
                        ...
                        if (containsVulgarOrSARA(fallbackText)) {
                            console.warn("[AIChatService] Vulgar/SARA detected in Groq output. Returning fallback.");
                            fallbackText = "Maaf, aku cuma bisa bantu soal desain dan portfolio Ramos ya. Ada yang lain? 😊";
                        }
