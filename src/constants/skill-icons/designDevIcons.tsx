...
export const getDesignDevIcons = (className: string): Record<string, React.ReactNode> => ({
  figma: (
    <div
      className={`${className} flex items-center justify-center rounded bg-gradient-to-br from-orange-400 to-purple-500 text-white`}
    >
  ...
  sketch: (
    <div
      className={`${className} flex items-center justify-center rounded bg-yellow-500 text-xs font-bold text-white`}
    >
      Sk
    </div>
  ),
  affinity_designer: (
    <div
      className={`${className} flex items-center justify-center rounded bg-blue-700 text-xs font-bold text-white`}
    >
      AD
    </div>
  ),
  ...
  capcut: (
    <div className={`${className} flex items-center justify-center rounded bg-black text-white`}>
      <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
  ...
  finalcut: (
    <div
      className={`${className} flex items-center justify-center rounded bg-gray-800 text-xs font-bold text-white`}
    >
      FC
    </div>
  ),
  davinci: (
    <div
      className={`${className} flex items-center justify-center rounded bg-red-800 text-xs font-bold text-white`}
    >
      DV
    </div>
  ),
  chatgpt: (
    <div
      className={`${className} flex items-center justify-center rounded bg-green-600 text-white`}
    >
      <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
  ...
  claude: (
    <div
      className={`${className} flex items-center justify-center rounded bg-orange-600 text-xs font-bold text-white`}
    >
      CL
    </div>
  ),
  ...
  canva: (
    <div
      className={`${className} flex items-center justify-center rounded bg-gradient-to-br from-purple-400 to-blue-500 text-white`}
    >
      <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
  ...
  code: (
    <div className={`${className} flex items-center justify-center rounded bg-gray-800 text-white`}>
  ...
  javascript: (
    <div
      className={`${className} flex items-center justify-center rounded bg-yellow-500 text-xs font-bold text-black`}
    >
      JS
    </div>
  ),
  ...
  react: (
    <div className={`${className} flex items-center justify-center rounded bg-blue-400 text-white`}>
      <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
  ...
  python: (
    <div
      className={`${className} flex items-center justify-center rounded bg-blue-500 text-xs font-bold text-yellow-400`}
    >
      Py
    </div>
  ),
  brand: (
    <div
      className={`${className} flex items-center justify-center rounded bg-purple-500 text-white`}
    >
      <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 20 20">
        <path
          fillRule="evenodd"
  ...
  typography: (
    <div
      className={`${className} flex items-center justify-center rounded bg-green-500 text-xs font-bold text-white`}
    >
      Tt
    </div>
  ),
  social: (
    <div className={`${className} flex items-center justify-center rounded bg-pink-500 text-white`}>
      <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 20 20">
        <path
          fillRule="evenodd"
  ...
  motion: (
    <div
      className={`${className} flex items-center justify-center rounded bg-indigo-500 text-white`}
    >
      <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 20 20">
        <path
          fillRule="evenodd"
          d="M4 2a2 2 0 00-2 2v11a2 2 0 002 2h12a2 2 0 002-2V4a2 2 0 00-2-2H4zm5.6 8.4L7 8v4l2.6-1.6z"
          clipRule="evenodd"
        />
      </svg>
    </div>
  ...
  web: (
    <div className={`${className} flex items-center justify-center rounded bg-blue-600 text-white`}>
      <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 20 20">
        <path
          fillRule="evenodd"
          d="M12.316 3.051a1 1 0 01.633 1.265l-4 12a1 1 0 11-1.898-.632l4-12a1 1 0 011.265-.633zM5.707 6.293a1 1 0 010 1.414L3.414 10l2.293 2.293a1 1 0 11-1.414 1.414l-3-3a1 1 0 010-1.414l3-3a1 1 0 011.414 0zm8.586 0a1 1 0 011.414 0l3 3a1 1 0 010 1.414l-3 3a1 1 0 11-1.414-1.414L16.586 10l-2.293-2.293a1 1 0 010-1.414z"
  ...
  ui: (
    <div
      className={`${className} flex items-center justify-center rounded bg-teal-500 text-xs font-bold text-white`}
    >
      UI
    </div>
  ),
  ux: (
    <div
      className={`${className} flex items-center justify-center rounded bg-cyan-500 text-xs font-bold text-white`}
    >
      UX
    </div>
  ),
  design: (
    <div className={`${className} flex items-center justify-center rounded bg-gray-700 text-white`}>
      <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 20 20">
