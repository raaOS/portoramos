...
export const getIconMap = (className: string): Record<string, React.ReactNode> => ({
    ...
    indesign: (
        <div className={`${className} bg-pink-600 rounded flex items-center justify-center text-white text-xs font-bold`}>
            Id
        </div>
    ),
    premiere: (
        <div className={`${className} bg-purple-600 rounded flex items-center justify-center text-white text-xs font-bold`}>
            Pr
        </div>
    ),
    aftereffects: (
        <div className={`${className} bg-purple-700 rounded flex items-center justify-center text-white text-xs font-bold`}>
            Ae
        </div>
    ),
    lightroom: (
    ...
    xd: (
        <div className={`${className} bg-purple-500 rounded flex items-center justify-center text-white text-xs font-bold`}>
            Xd
        </div>
    ),
    acrobat: (
    ...
    // Figma & Design Tools
    figma: (
        <div className={`${className} bg-gradient-to-br from-orange-400 to-purple-500 rounded flex items-center justify-center text-white`}>
    ...
    sketch: (
        <div className={`${className} bg-yellow-500 rounded flex items-center justify-center text-white text-xs font-bold`}>
            Sk
        </div>
    ),
    ...
    // Affinity Products
    affinity_designer: (
        <div className={`${className} bg-blue-700 rounded flex items-center justify-center text-white text-xs font-bold`}>
            AD
        </div>
    ),
    affinity_photo: (
    ...
    // Video Editing
    capcut: (
        <div className={`${className} bg-black rounded flex items-center justify-center text-white`}>
            <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
    ...
    finalcut: (
        <div className={`${className} bg-gray-800 rounded flex items-center justify-center text-white text-xs font-bold`}>
            FC
        </div>
    ),
    davinci: (
        <div className={`${className} bg-red-800 rounded flex items-center justify-center text-white text-xs font-bold`}>
            DV
        </div>
    ),
    ...
    // AI Tools
    chatgpt: (
        <div className={`${className} bg-green-600 rounded flex items-center justify-center text-white`}>
            <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
    ...
    // Canva
    canva: (
        <div className={`${className} bg-gradient-to-br from-purple-400 to-blue-500 rounded flex items-center justify-center text-white`}>
            <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
    ...
    // Programming & Code
    code: (
        <div className={`${className} bg-gray-800 rounded flex items-center justify-center text-white`}>
    ...
    javascript: (
        <div className={`${className} bg-yellow-500 rounded flex items-center justify-center text-black text-xs font-bold`}>
            JS
        </div>
    ),
    typescript: (
    ...
    react: (
        <div className={`${className} bg-blue-400 rounded flex items-center justify-center text-white`}>
            <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
    ...
    python: (
        <div className={`${className} bg-blue-500 rounded flex items-center justify-center text-yellow-400 text-xs font-bold`}>
            Py
        </div>
    ),
    ...
    // Original icons
    brand: (
        <div className={`${className} bg-purple-500 rounded flex items-center justify-center text-white`}>
            <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
    ...
    typography: (
        <div className={`${className} bg-green-500 rounded flex items-center justify-center text-white text-xs font-bold`}>
            Tt
        </div>
    ),
    social: (
        <div className={`${className} bg-pink-500 rounded flex items-center justify-center text-white`}>
            <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
    ...
    motion: (
        <div className={`${className} bg-indigo-500 rounded flex items-center justify-center text-white`}>
            <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
    ...
    web: (
        <div className={`${className} bg-blue-600 rounded flex items-center justify-center text-white`}>
            <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M12.316 3.051a1 1 0 01.633 1.265l-4 12a1 1 0 11-1.898-.632l4-12a1 1 0 011.265-.633zM5.707 6.293a1 1 0 010 1.414L3.414 10l2.293 2.293a1 1 0 11-1.414 1.414l-3-3a1 1 0 010-1.414l3-3a1 1 0 011.414 0zm8.586 0a1 1 0 011.414 0l3 3a1 1 0 010 1.414l-3 3a1 1 0 11-1.414-1.414L16.586 10l-2.293-2.293a1 1 0 010-1.414z" clipRule="evenodd" />
            </svg>
        </div>
    ...
    ui: (
        <div className={`${className} bg-teal-500 rounded flex items-center justify-center text-white text-xs font-bold`}>
            UI
        </div>
    ),
    ux: (
        <div className={`${className} bg-cyan-500 rounded flex items-center justify-center text-white text-xs font-bold`}>
            UX
        </div>
    ),
    design: (
        <div className={`${className} bg-gray-700 rounded flex items-center justify-center text-white`}>
            <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
