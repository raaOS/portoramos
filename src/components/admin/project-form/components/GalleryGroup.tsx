...
export default function GalleryGroup({
  ...
  return (
    <div className="space-y-3 rounded-lg border border-slate-200/80 bg-slate-50/20 p-3 dark:border-slate-800 dark:bg-slate-900/10">
      <div className="flex items-center justify-between gap-3 border-b border-slate-100 pb-1 dark:border-slate-800/80">
        <div className="flex flex-1 items-center gap-1.5">
          ...
          <input
            ...
            className="w-full border-none bg-transparent p-0 text-xs font-semibold text-slate-800 placeholder-slate-300 focus:outline-none focus:ring-0 dark:text-slate-200 dark:placeholder-slate-700"
          />
        </div>
      ...
      <div className="grid grid-cols-3 gap-2">
        ...
        <button
          ...
          className="dark:hover:text-slate-250 group flex aspect-square flex-col items-center justify-center gap-1.5 rounded border border-dashed border-slate-200 bg-white text-slate-400 transition-all hover:border-slate-800 hover:text-slate-800 dark:border-slate-800 dark:bg-slate-900 dark:text-slate-500 dark:hover:border-slate-400"
        >
          <Plus
            size={16}
            className="text-slate-400 transition-transform group-hover:scale-110 dark:text-slate-500"
          />
