...
export default function ProjectTelemetryFields({
  ...
  if (!showViralStats) {
    return (
      <div className="flex h-36 flex-col items-center justify-center rounded-lg border border-dashed border-slate-200 bg-slate-50/20 p-4 text-center text-slate-400 dark:border-slate-800 dark:bg-slate-900/10">
        <Activity className="mb-2 h-6 w-6 text-slate-400 opacity-40 dark:text-slate-500" />
  ...
  return (
    <div className="space-y-4">
      <div className="space-y-4 pt-1">
        ...
        <div className="flex items-center justify-between rounded-lg border border-slate-100 bg-slate-50/30 p-2.5 dark:border-slate-800/80 dark:bg-slate-900/20">
          ...
          <label className="relative inline-flex cursor-pointer items-center">
            ...
            />
            <div className="peer h-4 w-7 rounded-full bg-slate-200 after:absolute after:left-[2px] after:top-[2px] after:h-3 after:w-3 after:rounded-full after:bg-white after:transition-all after:content-[''] peer-checked:bg-slate-900 peer-checked:after:translate-x-full peer-focus:outline-none dark:bg-slate-800 dark:peer-checked:bg-slate-100"></div>
          </label>
        </div>
      </div>
    </div>
