    ...
    return (
        ...
        >
            ...
            <div className="flex items-center gap-4">
                <Link href="/" onClickCapture={markBack} className="flex items-center px-2 py-1 rounded cursor-pointer transition-colors" aria-label="Home">
                ...
                {!isProjectsPage && !isPrintMode && (
                    <nav className="hidden md:flex items-center gap-1 font-medium">
                        ...
                        <Link href="/" onClickCapture={markBack} className="px-3 py-1 rounded cursor-pointer transition-colors hover:bg-black/5">About</Link>
