            ...
            {isOpen && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center">
                    ...
                    <motion.div
                        ...
                        onClick={handleClose}
                        className="fixed inset-0 bg-black/70 cursor-pointer print:hidden"
                    />
                    ...
                    >
                        ...
                        <button
                            onClick={handleClose}
                            className="absolute top-4 right-4 z-50 p-2.5 bg-white dark:bg-gray-800 rounded-full text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 transition-all shadow-lg hover:shadow-xl border border-gray-200/50 dark:border-gray-700/50 print:hidden"
