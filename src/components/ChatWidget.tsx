...
export default function ChatWidget() {
    ...
    return (
        <div className="fixed bottom-40 left-1/2 -translate-x-1/2 md:left-auto md:right-6 md:translate-x-0 md:bottom-6 z-50 flex flex-col items-center md:items-end w-full max-w-[calc(100vw-2rem)] md:w-auto font-sans">
            {/* Chat Box */}
            {isOpen && (
