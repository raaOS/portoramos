...
export default function ShareButtons({ 
  ...
  const shareButtons = [
    { 
      ...
      color: 'hover:bg-blue-100 text-blue-400'
    },
    { 
      name: 'LinkedIn', 
  ...
  return (
    <div className={`flex flex-col space-y-4 ${className}`}>
      <h3 className="text-lg font-semibold text-gray-900 mb-2">Share Project</h3>
      ...
      <div className="flex flex-wrap sm:flex-nowrap gap-2 sm:gap-3">
        {shareButtons.map((button) => (
          <motion.button
            ...
            className={`
              ...
              transition-all duration-200 ${button.color}
        ...
        <motion.button
          ...
          className={`
            flex items-center justify-center w-10 h-10 rounded-lg border border-gray-200 
            transition-all duration-200 hover:bg-gray-100 text-gray-600
