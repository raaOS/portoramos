      ...
      >
        ...
        {!isExpanded && (
          <button
            ...
            className="ml-1 inline-block cursor-pointer rounded text-lg font-medium text-blue-600 transition-all duration-200 hover:text-blue-800 focus:outline-none focus:ring-2 focus:ring-blue-300 focus:ring-opacity-50"
            type="button"
          >
            selengkapnya
          </button>
      ...
      <AnimatePresence>
        {isExpanded && (
          <motion.div
            ...
            className="mt-2"
          >
            <p className="text-gray-700">{sentences.slice(initialSentences).join('. ') + '.'}</p>
            <button
              onClick={handleToggle}
              className="mt-2 text-lg font-medium text-blue-600 transition-colors duration-200 hover:text-blue-800"
            >
              Sembunyikan
            </button>
          </motion.div>
