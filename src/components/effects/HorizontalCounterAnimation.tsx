...
export default function HorizontalCounterAnimation() {
  ...
  return (
    <div
      className="w-full max-w-[90%] md:max-w-5xl overflow-hidden mx-auto"
      style={{
      ...
      >
        ...
        {[...counterItems, ...counterItems, ...counterItems].map((item, index) => (
          <div key={`${item.id}-${index}`} className="flex-shrink-0 w-[160px] mr-4">
            <div className="bg-white/5 rounded-lg p-4 shadow-sm h-[100px] border border-white/10 hover:border-white/30 hover:bg-white/10 transition-all duration-300 cursor-pointer flex flex-col justify-center">
