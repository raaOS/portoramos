...
export default function AITranslator({ text, className = '', context = '' }: AITranslatorProps) {
    ...
    const handleTranslate = async () => {
        ...
        if (cached) {
            console.log('Restoring translation from cache');
    ...
    return (
        <>
            <button
                ...
                className={`inline-flex items-center gap-1.5 text-xs font-medium text-blue-600 hover:text-blue-800 transition-colors bg-blue-50 hover:bg-blue-100 px-2.5 py-1 rounded-full ${className}`}
