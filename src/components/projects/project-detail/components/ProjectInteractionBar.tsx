    ...
    <div className="flex flex-wrap items-center justify-between gap-4 pt-2">
      <div className="flex items-center gap-2">
        ...
        >
          ...
          {metrics.likes > 0 && <span className="pr-1 text-sm font-medium">{metrics.likes}</span>}
        </button>
        ...
        >
          ...
          {commentCount > 0 && <span className="pr-1 text-sm font-medium">{commentCount}</span>}
        </button>

        {/* Share Button */}
        <button
          className={`flex items-center gap-1 rounded-full p-1.5 transition-all duration-200 ${
            metrics.shares > 0 ? 'text-blue-500' : 'text-gray-400 hover:text-blue-500'
          }`}
          onClick={() => {
            onShare();
            setIsShareOpen(true);
        ...
        >
          ...
          {metrics.shares > 0 && <span className="pr-1 text-sm font-medium">{metrics.shares}</span>}
        </button>
        ...
        <button
          ...
          className={`flex items-center gap-1 rounded-full p-1.5 transition-all duration-200 disabled:opacity-50 ${
            translations
