    ...
    return (
        <div className="mt-12 mb-8 font-sans">
            ...
            <div className="react-tabs-container">
                            ...
                            return (
                                <button
                                    ...
                                    className={`
                                        ...
                                        outline-none -mb-[1px]
                                        ${isActive
                                            ? `${tabStyles[tab.id].bg} rounded-t-md rounded-b-none text-white z-20 transition-all duration-150 -mb-px`
                ...
                <div className={`
                    border-x border-b border-black/10 dark:border-white/10 
                    ${currentStyle.border}
                    rounded-b-md px-6 py-8 sm:px-10 sm:py-10 min-h-[220px] 
