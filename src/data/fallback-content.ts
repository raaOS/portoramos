...
export const FALLBACK_WORK_EXPERIENCE: ExperienceData['workExperience'] = [
  {
    ...
    imageUrl:
      'https://images.unsplash.com/photo-1572044162444-ad6021194360?auto=format&fit=crop&w=100&q=80',
  },
  {
    ...
    imageUrl:
      'https://images.unsplash.com/photo-1524178232363-1fb2b075b655?auto=format&fit=crop&w=100&q=80',
  },
  {
...
export const FALLBACK_ABOUT_DATA = {
  ...
  professional: {
    ...
    bio: {
      content:
        'Desainer grafis dengan lebih dari 14 tahun pengalaman di brand dan kampanye digital. Fokus pada visual bersih, tipografi kuat, dan storytelling yang relevan bisnis.',
      galleryImages: [],
    },
  },
};
