...
const BOOT_CONFIG = {
    ...
    totalDuration: 2000 + 2000 + REVEAL_DURATION_MS - REVEAL_OVERLAP_MS,
    allowSkip: true,
} as const;

const SHOW_TEXT_DELAY_MS = BOOT_CONFIG.keyholeZoomDuration - REVEAL_OVERLAP_MS;
const GLASS_REVEAL_DELAY_MS =
    BOOT_CONFIG.keyholeZoomDuration + BOOT_CONFIG.textDisplayDuration - REVEAL_OVERLAP_MS;
const COMPLETE_DELAY_MS = GLASS_REVEAL_DELAY_MS + BOOT_CONFIG.revealDuration;
                ...
                >
                    ...
                    <g transform="translate(50, 50) scale(0.6) translate(-31.056, -4.345)">
                        <m.g
                            fill="black"
                            initial={{ opacity: 0 }}
                            animate={{ opacity: isWordmarkVisible ? 1 : 0 }}
