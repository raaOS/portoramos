...
const StartScreen = ({ onStart, isActive, onReady, onReveal }: StartScreenProps) => {
    ...
    const handleClick = useCallback(() => {
        ...
        // Calculation: 2000 (zoom) + 2000 (text) + 2500 (reveal duration) - 200 (reveal offset) = 6300ms
        timersRef.current.push(setTimeout(() => {
            setScreenState("done");
            onStart();
        }, BOOT_CONFIG.keyholeZoomDuration + BOOT_CONFIG.textDisplayDuration + 2500 - 200));
                ...
                >
                    <defs>
                        <mask id="hollow-o-mask">
                            ...
                            {/* Radius unified to 2.235 to match the white plug circle exactly */}
                    ...
                    >
                        ...
                        */}
                        <g transform="translate(50, 50) scale(0.6) translate(-31.056, -4.345)">
                            {/* All text now stays visible during expansion to create a full recursive zoom effect */}
                            <g>
                                {/* R (DM Sans) */}
                                ...
                                {/* O (The Portal) - Scaled to match bold weight of DM Sans (approx 1.8 units) */}
                                <circle 
                                    cx="31.056" 
                                    cy="4.345" 
                                    r="3.8" 
