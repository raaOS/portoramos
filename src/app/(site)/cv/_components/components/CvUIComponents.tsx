...
import { FileText, Printer, Globe, CheckCircle2 } from 'lucide-react';
  ...
  <div className="grid grid-cols-1 gap-4 md:grid-cols-2 print:grid-cols-2">
    <CvSection title="Hard Skills">
      {hardSkills.length > 0 ? (
        ...
        <p className="mt-2 text-sm text-gray-600">Data hard skills belum tersedia.</p>
      )}
    </CvSection>
    <CvSection title="Soft Skills">
      {softSkills.length > 0 ? (
        ...
        <p className="mt-2 text-sm text-gray-600">Data soft skills belum tersedia.</p>
      )}
    </CvSection>
  </div>
);
