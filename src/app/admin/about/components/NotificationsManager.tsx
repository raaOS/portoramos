...
export default function NotificationsManager({
  ...
  return (
    <div className="space-y-6">
      ...
      {/* List View Container */}
      <div className="mb-20 overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm">
        ...
        {localNotifications.length === 0 && (
          <div className="bg-gray-50 py-20 text-center">
            ...
            <button
              onClick={handleAdd}
              className="mt-6 rounded-xl bg-indigo-600 px-6 py-2.5 text-xs font-bold text-white shadow-lg shadow-indigo-100 transition-all hover:bg-indigo-700"
            >
              Tambah Sekarang
            </button>
          </div>
