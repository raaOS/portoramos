      ...
      <div className="grid grid-cols-1 gap-6 rounded-3xl border border-indigo-50 bg-indigo-50/20 p-6 shadow-inner md:grid-cols-3">
        <div>
          ...
          <input
            ...
            className="w-full rounded-lg border border-indigo-100 bg-white px-4 py-3 text-sm font-bold shadow-sm transition-all focus:outline-none focus:ring-2 focus:ring-indigo-400"
        ...
        <div>
          ...
          <input
            ...
            className="w-full rounded-lg border border-indigo-100 bg-white px-4 py-3 font-mono text-[10px] shadow-sm transition-all focus:outline-none focus:ring-2 focus:ring-indigo-400"
            placeholder="https://..."
          />
        </div>
        <div>
