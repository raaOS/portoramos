      ...
      <div className="mb-4 rounded-3xl border border-violet-100 bg-gradient-to-r from-violet-50 to-fuchsia-50 p-4">
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="flex items-center gap-2 rounded-lg bg-violet-600 px-4 py-2 text-[10px] font-black uppercase tracking-wider text-white shadow-lg shadow-violet-200 transition-all hover:bg-violet-700 disabled:opacity-50"
          >
      ...
      <div className="mb-2 flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
        ...
        <div className="flex items-center gap-4 self-end sm:self-auto">
          ...
          <button
            ...
            className="flex items-center gap-2 rounded-lg bg-indigo-600 px-6 py-2.5 text-xs font-black uppercase tracking-tighter text-white shadow-md transition-all hover:bg-indigo-700"
          >
        ...
        <div className="max-h-[600px] space-y-6 overflow-y-auto pr-2">
          {(notif.conversation || []).map((msg: ChatMessage, idx: number) => (
            ...
            >
              ...
              <div
                className={`max-w-[100%] flex-1 rounded-xl border px-4 pb-3 pt-3 transition-all ${msg.isMe ? 'rounded-tr-none border-[#beddb0] bg-[#DCF8C6] text-gray-800' : 'rounded-tl-none border-black/10 bg-white text-gray-800'}`}
              >
              ...
              <button
                ...
                className="shrink-0 self-center rounded-xl p-3 text-gray-200 opacity-0 transition-all hover:bg-red-50 hover:text-red-500 group-hover/msg:opacity-100"
              >
                <Trash2 size={20} />
              </button>
            </div>
