...
export default function TestimonialCard({
  ...
  return (
    <div className="group relative rounded-2xl border border-gray-100 bg-white p-5 shadow-sm transition-all hover:border-violet-200 hover:shadow-xl">
      ...
      <div className="mb-4 line-clamp-2 rounded-xl border border-gray-100 bg-gray-50 p-3 text-xs italic text-gray-600">
        &quot;{t.notificationText}&quot;
      </div>
