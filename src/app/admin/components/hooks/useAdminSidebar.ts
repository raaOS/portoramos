...
export function useAdminSidebar() {
  ...
  const expandedMenus = useMemo(
    () => ({
      '/admin/projects-group':
        routeExpandedMenus['/admin/projects-group'] || manualExpandedMenus['/admin/projects-group'],
      '/admin/about-group':
        routeExpandedMenus['/admin/about-group'] || manualExpandedMenus['/admin/about-group'],
      '/admin/contact-group':
        routeExpandedMenus['/admin/contact-group'] || manualExpandedMenus['/admin/contact-group'],
      '/admin/os-config':
        routeExpandedMenus['/admin/os-config'] || manualExpandedMenus['/admin/os-config'],
    }),
