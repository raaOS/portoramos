...
export default function DataConnectionModal({ onCancel }: DataConnectionModalProps) {
    ...
    const isConnected = health?.database === 'connected' && health?.databaseBackend === 'cloudflare-d1';
            ...
            <div className="space-y-6">
                        ...
                        <div className="flex items-start">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-600 mt-1">
                                    Data proyek, komentar, dan chat disimpan di Cloudflare D1.
                                    Perubahan dicek berkala dari endpoint versi data.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                        <div className="flex items-start">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-600 mt-1">
                                    Gambar dan aset media disimpan di Cloudflare R2.
                                    Storage media lama sudah tidak dipakai.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                    ...
                    <p className="text-sm text-blue-800">
                        Cloudflare D1 dan R2 dikonfigurasi melalui environment variables di server.
