        ...
        {projects.map((p) => {
          ...
          return (
            <button
              ...
              disabled={isDisabled}
              className={`group relative flex aspect-square flex-col items-center justify-center gap-4 rounded-xl border-2 border-transparent p-4 transition-all duration-200 ${
                isSelected
                  ? 'scale-[1.02]'
                  : isDisabled
            ...
            >
              ...
              <div className="relative aspect-[1.15/1] w-full flex-1">
                ...
                <div className="absolute inset-0 flex items-center justify-center overflow-hidden rounded-lg bg-gray-50">
                  {p.cover ? (
