...
import { useAdminExperience } from '@/app/admin/hooks/useAdminExperience';
import { useConfirm } from '@/components/admin/ConfirmDialog';
import { WorkExperience } from '@/types/experience';

// Modular Components
import StatsSection from '@/app/admin/content/experience/components/StatsSection';
import ExperienceCard from '@/app/admin/content/experience/components/ExperienceCard';
import ExperienceForm from '@/app/admin/content/experience/components/ExperienceForm';
          ...
          <section className="space-y-4">
            ...
            {isAddingNew || editingId !== null ? (
              <ExperienceForm
                ...
                onSave={async (item: WorkExperience) => {
