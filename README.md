...
Ringkas: Next.js (App Router) + Tailwind + Framer Motion, masonry responsif, transisi shared element, bilingual (IN/EN), upload gambar/video (GitHub) via Admin, dan penyimpanan proyek via Upstash (Vercel KV) agar perubahan tersimpan tanpa rebuild.
...
- Admin: tambah/edit/hapus proyek, unggah image/video via GitHub.
...
- Panel: `/admin` → tambah proyek (Cover Image/Video + Poster, Galeri URL). Tombol Upload ke GitHub tersedia.
